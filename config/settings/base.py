...
LOCAL_APPS = [
    "spotifygame.users.apps.UsersConfig",
...
MIGRATION_MODULES = {
    "sites": "spotifygame.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "spotifygame.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "spotifygame.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "spotifygame.users.adapters.SocialAccountAdapter"
)
